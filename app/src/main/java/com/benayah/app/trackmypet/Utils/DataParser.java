       ...
       // String formatted_phone="-NA-";
        ...
        try {
            ...
            if(!googlePlaceJson.isNull("international_phone_number")){
                String formatted_phone = googlePlaceJson.getString("international_phone_number");
                Log.d("formatted_phone",formatted_phone);
            }
            ...
            googlePlaceMap.put("place_id1",place_id);
            //googlePlaceMap.put("formatted_phone_number", formatted_phone);
